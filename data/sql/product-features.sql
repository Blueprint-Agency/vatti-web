...
SELECT id, 1, 'banner', NULL, NULL,
  'https://cdn.vattimalaysia.com/2023/11/V993-Kitchen-Hood-1.webp',
...
SELECT id, 2, 'card', 'Lifting type air inlet',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v993-highlight-lifting-inlet.webp',
...
SELECT id, 3, 'card', 'Closer to the smoke source',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v993-highlight-inlet-height.webp',
...
SELECT id, 4, 'card', 'Flow deflecting oil filter',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v993-highlight-oil-filter.webp',
...
SELECT id, 5, 'card', 'Turbo suction',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v993-highlight-turbo-suction.webp',
...
Elegant to look at, and one continuous surface to wipe down.',
  'https://cdn.vattimalaysia.com/2026/08/v993-finish-detail.webp',
...
SELECT id, 7, 'split', 'Laser seamless welding',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v993-laser-welding.webp',
...
SELECT id, 8, 'split', 'Curved body finishing',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v993-curved-body.webp',
...
- Less noise while it is running',
  'https://cdn.vattimalaysia.com/2026/08/v993-waterproof-motor.webp',
...
INSERT INTO product_feature (product_id, position, layout, title, body_md, image_url, image_alt, image_w, image_h)
SELECT id, 1, 'banner', NULL, NULL,
  'https://cdn.vattimalaysia.com/2026/08/v929-clean-air-kitchen.webp',
...
- Built-in oil cup
- Nano coating',
  'https://cdn.vattimalaysia.com/2026/08/v929-glass-panel.webp',
...
SELECT id, 4, 'split', '46.5 dB at full tilt',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v929-quiet-kitchen.webp',
...
SELECT id, 5, 'split', 'It reads the air, not the clock',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v929-pm25-kitchen.webp',
...
SELECT id, 6, 'split', 'Booster clean',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v929-booster-clean.webp',
...
An ambient light sits under the same panel.',
  'https://cdn.vattimalaysia.com/2025/07/V929-PG-13.webp',
...
SELECT id, 8, 'split', 'It starts when the hob does',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v929-ai-auto-link.webp',
...
SELECT id, 9, 'split', '79% more smoke collection area',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v929-smoke-capture.webp',
...
SELECT id, 10, 'split', '1.2 cm of panel',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v929-slim-panel.webp',
...
SELECT id, 11, 'card', 'Built into the cabinet',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v929-cabinet-integrated.webp',
...
SELECT id, 12, 'card', 'Standing on its own',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v929-independent.webp',
  'The V929 wall-mounted with its chimney showing', 691, 594
  FROM product WHERE slug = 'vatti-aetheris-series-cooker-hood-v929';

INSERT INTO product_feature (product_id, position, layout, title, body_md, image_url, image_alt, image_w, image_h)
SELECT id, 13, 'banner', NULL, NULL,
  'https://cdn.vattimalaysia.com/2026/08/v929-art-design.webp',
...
INSERT INTO product_feature (product_id, position, layout, title, body_md, image_url, image_alt, image_w, image_h)
SELECT id, 1, 'banner', NULL, NULL,
  'https://cdn.vattimalaysia.com/2026/08/v999-side-hood.webp',
...
It also solves the T-shape''s other problem: there is nothing at head height to walk into.',
  'https://cdn.vattimalaysia.com/2026/08/v999-smoke-chamber.webp',
...
SELECT id, 3, 'split', 'A wide angle over the whole hob',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v999-wide-angle.webp',
...
SELECT id, 4, 'split', 'Inverter DC motor',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v999-dc-motor.webp',
...
SELECT id, 5, 'split', 'Boaster suction, for the wok minute',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v999-suction.webp',
...
SELECT id, 6, 'split', 'R80 curved body',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v999-r80-curve.webp',
...
SELECT id, 7, 'split', 'Laser seamless welding',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v999-laser-weld.webp',
...
- One less surface to wipe down',
  'https://cdn.vattimalaysia.com/2026/08/v999-hand-sensor.webp',
...
- 30 seconds of high-speed spinning to dry the motor',
  'https://cdn.vattimalaysia.com/2026/08/v999-steam-clean.webp',
...
- Lower working temperature, longer service life
- Less noise while it is running',
  'https://cdn.vattimalaysia.com/2026/08/v999-waterproof-motor.webp',
  'The sealed motor unit of the V999', 309, 173
  FROM product WHERE slug = 'athena-series-lifting-type-range-hood-v999';

INSERT INTO product_feature (product_id, position, layout, title, body_md, image_url, image_alt, image_w, image_h)
SELECT id, 11, 'banner', NULL, NULL,
  'https://cdn.vattimalaysia.com/2026/08/v999-impeller.webp',
...
INSERT INTO product_feature (product_id, position, layout, title, body_md, image_url, image_alt, image_w, image_h)
SELECT id, 1, 'banner', NULL, NULL,
  'https://cdn.vattimalaysia.com/2026/08/v998-hero.webp',
...
SELECT id, 2, 'split', '12.6 cm of panel',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v998-ultraslim.webp',
...
SELECT id, 3, 'split', 'Flat into any cabinet run',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v998-flat-install.webp',
...
SELECT id, 4, 'split', '2,850 m³/h at 1,250 Pa',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v998-dual-suction.webp',
...
SELECT id, 5, 'split', 'A wide screen over the smoke',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v998-wide-screen.webp',
...
SELECT id, 6, 'split', 'Why the screen is wide, not narrow',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v998-screen-compared.webp',
...
SELECT id, 7, 'split', 'It starts when the hob does',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v998-auto-link.webp',
...
SELECT id, 8, 'split', 'It measures what it has missed',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v998-particle-capture.webp',
...
SELECT id, 9, 'split', 'Baby skin touch glass',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v998-ag-glass.webp',
...
- Nanometre oil-repellent surface',
  'https://cdn.vattimalaysia.com/2026/08/v998-glass-layers.webp',
...
SELECT id, 11, 'split', 'Steam and hot water together',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v998-steam-wash.webp',
...
SELECT id, 12, 'card', 'Oil-repellent guide plate',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v998-guide-plate.webp',
...
SELECT id, 13, 'card', 'Nothing to remove',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v998-meshless.webp',
...
SELECT id, 14, 'card', 'An oil cup you empty less',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v998-oil-cup.webp',
...
SELECT id, 15, 'split', 'The panel tells you where you are',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v998-ui-panel.webp',
...
INSERT INTO product_feature (product_id, position, layout, title, body_md, image_url, image_alt, image_w, image_h)
SELECT id, 1, 'banner', NULL, NULL,
  'https://cdn.vattimalaysia.com/2026/08/v937-hero.webp',
...
SELECT id, 2, 'split', 'Three cavities, in a 1:5:1',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v937-three-cavity.webp',
...
SELECT id, 3, 'split', 'It matches the duct it is fitted to',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v937-smart-suction.webp',
...
- Pour the dirty water out and put the oil cup back',
  'https://cdn.vattimalaysia.com/2026/08/v937-auto-clean.webp',
...
SELECT id, 5, 'split', 'The whole filter comes out',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v937-oil-filter.webp',
...
- Porous sound-absorbing material, for what is left',
  'https://cdn.vattimalaysia.com/2026/08/v937-noise.webp',
...
SELECT id, 7, 'card', 'LED soft light',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v937-led-light.webp',
...
SELECT id, 8, 'card', 'Detachable oil filter',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v937-filter-out.webp',
...
SELECT id, 9, 'card', 'Hand gesture control',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v937-gesture.webp',
  'A hand held under the V937 panel', 363, 192
  FROM product WHERE slug = 'triple-intake-series-t-type-cooker-hood-v937';

INSERT INTO product_feature (product_id, position, layout, title, body_md, image_url, image_alt, image_w, image_h)
SELECT id, 10, 'banner', NULL, NULL,
  'https://cdn.vattimalaysia.com/2023/11/VATTI_V937_side-NEW.webp',
...
INSERT INTO product_feature (product_id, position, layout, title, body_md, image_url, image_alt, image_w, image_h)
SELECT id, 1, 'banner', NULL, NULL,
  'https://cdn.vattimalaysia.com/2026/08/v938-hero.webp',
...
SELECT id, 2, 'split', 'Half hidden, and that is the point',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v938-half-hidden.webp',
...
SELECT id, 3, 'split', '3,650 m³/h against 1,600 Pa',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v938-clean-cooking.webp',
...
SELECT id, 4, 'split', 'BLDC inverter motor',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v938-bldc-motor.webp',
...
SELECT id, 5, 'split', 'Vertical capture, at the pan',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v938-vertical-capture.webp',
...
SELECT id, 6, 'split', 'Capture ratio 1:5:1',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v938-capture-ratio.webp',
...
SELECT id, 7, 'split', '47 dB, and it decides for itself',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v938-quiet.webp',
...
SELECT id, 8, 'split', 'Wave, do not touch',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v938-gesture.webp',
...
SELECT id, 9, 'split', 'It starts and stops on its own',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v938-auto-start.webp',
...
SELECT id, 10, 'split', 'It keeps working when you are not cooking',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v938-air-manager.webp',
...
SELECT id, 11, 'split', 'The display tells you the air',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v938-display.webp',
...
SELECT id, 12, 'split', 'Steam and hot water, together',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v938-steam-clean.webp',
...
SELECT id, 13, 'split', 'From the phone, if you want',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v938-app.webp',
...
SELECT id, 14, 'card', 'Classic elegant',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v938-style-classic.webp',
...
SELECT id, 15, 'card', 'Light luxury Italian',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v938-style-italian.webp',
...
SELECT id, 16, 'card', 'Modern minimal',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v938-style-minimal.webp',
  'The V938 in a minimal timber kitchen', 1083, 266
  FROM product WHERE slug = 'vatti-hidden-series-range-hood-v938';

INSERT INTO product_feature (product_id, position, layout, title, body_md, image_url, image_alt, image_w, image_h)
SELECT id, 17, 'banner', NULL, NULL,
  'https://cdn.vattimalaysia.com/2026/05/VATTI-Kitchen-Hood-V938_front_open.webp',
...
INSERT INTO product_feature (product_id, position, layout, title, body_md, image_url, image_alt, image_w, image_h)
SELECT id, 1, 'banner', NULL, NULL,
  'https://cdn.vattimalaysia.com/2026/08/v919-hero.webp',
...
SELECT id, 2, 'split', 'A slim body, in a cabinet',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v919-ultra-thin.webp',
...
SELECT id, 3, 'split', '3,050 m³/h of turbo suction',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v919-suction.webp',
...
SELECT id, 4, 'split', '1,300 Pa of static pressure',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v919-pressure.webp',
...
SELECT id, 5, 'split', 'It reads the duct while you cook',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v919-adjustable.webp',
...
SELECT id, 6, 'split', 'A closed negative pressure bottom',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v919-negative-pressure.webp',
...
SELECT id, 7, 'split', 'Steam washing, then dry',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v919-steam-wash.webp',
...
- Pour the water cup off and put the oil cup back',
  'https://cdn.vattimalaysia.com/2026/08/v919-four-steps.webp',
...
SELECT id, 9, 'card', 'Quick-release oil filter',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v919-quick-release.webp',
...
SELECT id, 10, 'card', 'Segmented, for the dishwasher',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v919-segmented-filter.webp',
...
SELECT id, 11, 'split', 'A 5.1 inch screen, and a hand sensor',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v919-touch-screen.webp',
...
SELECT id, 12, 'split', 'Quiet at 50 dB',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v919-noise.webp',
...
SELECT id, 13, 'split', 'Three ways to fit it',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v919-installations.webp',
  'The V919 shown open, in a cabinet and built in', 967, 428
  FROM product WHERE slug = 'vatti-magic-series-cooker-hood-v919';

INSERT INTO product_feature (product_id, position, layout, title, body_md, image_url, image_alt, image_w, image_h)
SELECT id, 14, 'banner', NULL, NULL,
  'https://cdn.vattimalaysia.com/2024/03/Megic-Series-Hood-V919_Product-Image-3.webp',
...
INSERT INTO product_feature (product_id, position, layout, title, body_md, image_url, image_alt, image_w, image_h)
SELECT id, 1, 'banner', NULL, NULL,
  'https://cdn.vattimalaysia.com/2026/08/v997-hero.webp',
...
SELECT id, 2, 'split', 'Top suction, or side suction',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v997-suction-types.webp',
...
SELECT id, 3, 'split', 'The V997 does both',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v997-combination.webp',
...
SELECT id, 4, 'split', 'Four chambers, three generations in',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v997-generations.webp',
...
SELECT id, 5, 'split', 'BLDC motor, 2,800 m³/h at 1,200 Pa',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v997-bldc-motor.webp',
...
SELECT id, 6, 'split', 'Turbo wash, the fifth generation',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v997-turbo-wash.webp',
...
SELECT id, 7, 'card', 'AG grey',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v997-colour-grey.webp',
...
SELECT id, 8, 'card', 'Pearl white',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v997-colour-white.webp',
...
SELECT id, 9, 'card', 'Black',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v997-colour-black.webp',
...
INSERT INTO product_feature (product_id, position, layout, title, body_md, image_url, image_alt, image_w, image_h)
SELECT id, 1, 'banner', NULL, NULL,
  'https://cdn.vattimalaysia.com/2023/11/J-657AZ-4.webp',
...
- Swing right to left to switch it off',
  'https://cdn.vattimalaysia.com/2026/08/v991-hand-gesture.webp',
...
SELECT id, 3, 'split', 'A baffle plate that closes behind the smoke',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v991-baffle-plate.webp',
...
SELECT id, 4, 'split', 'Patented V-shaped housing',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v991-v-housing.webp',
...
SELECT id, 5, 'split', 'Piano black, with a champagne line',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v991-piano-black.webp',
...
INSERT INTO product_feature (product_id, position, layout, title, body_md, image_url, image_alt, image_w, image_h)
SELECT id, 1, 'banner', NULL, NULL,
  'https://cdn.vattimalaysia.com/2023/11/V931-C.webp',
...
INSERT INTO product_feature (product_id, position, layout, title, body_md, image_url, image_alt, image_w, image_h)
SELECT id, 1, 'banner', NULL, NULL,
  'https://cdn.vattimalaysia.com/2026/08/v996-hero.webp',
...
SELECT id, 2, 'split', 'Side and top inlet, in one body',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v996-depth-tiles.webp',
...
SELECT id, 3, 'split', '500 Pa of static pressure',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v996-pressure.webp',
...
SELECT id, 4, 'split', 'Heat auto clean',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v996-heat-clean.webp',
...
SELECT id, 5, 'split', 'Seventeen minutes, in seven stages',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v996-clean-cycle.webp',
...
SELECT id, 6, 'split', 'A guide plate that lifts out',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v996-guide-plate.webp',
...
SELECT id, 7, 'split', 'Left to right on, right to left off',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v996-hand-sensor.webp',
...
SELECT id, 8, 'card', 'Under the cabinets',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v996-in-cabinets.webp',
...
SELECT id, 9, 'card', 'On the wall',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v996-on-wall.webp',
...
INSERT INTO product_feature (product_id, position, layout, title, body_md, image_url, image_alt, image_w, image_h)
SELECT id, 1, 'banner', NULL, NULL,
  'https://cdn.vattimalaysia.com/2026/05/VATTI-Kitchen-Hood-V960_front_open.webp',
...
SELECT id, 2, 'split', '225mm slim, and it opens without protruding',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v960-slim.webp',
...
SELECT id, 3, 'split', '3,690 m³/h, and 25.9 seconds',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v960-airflow.webp',
...
SELECT id, 4, 'split', '1,700 Pa of static pressure',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v960-pressure.webp',
...
SELECT id, 5, 'split', 'A chamber for each burner',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v960-dual-chamber.webp',
...
SELECT id, 6, 'split', '48 dB, held under power',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v960-quiet.webp',
...
SELECT id, 7, 'split', 'The display wakes as you walk in',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v960-motion-display.webp',
...
SELECT id, 8, 'split', 'Radar, not a proximity sensor',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v960-radar.webp',
...
SELECT id, 9, 'split', 'It syncs with the hob, and with the phone',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v960-auto-sync.webp',
...
SELECT id, 10, 'split', 'PM2.5, measured rather than assumed',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v960-pm25.webp',
...
SELECT id, 11, 'split', 'Pulse-wave wash',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v960-self-clean.webp',
...
SELECT id, 12, 'split', 'AG glass, not ordinary glass',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v960-surface.webp',
  'A finger drawn across AG glass beside conventional glass', 1054, 418
  FROM product WHERE slug = 'vatti-stellar-series-cooker-hood-v960';

INSERT INTO product_feature (product_id, position, layout, title, body_md, image_url, image_alt, image_w, image_h)
SELECT id, 13, 'banner', NULL, NULL,
  'https://cdn.vattimalaysia.com/2026/08/v960-hero.webp',
...
INSERT INTO product_feature (product_id, position, layout, title, body_md, image_url, image_alt, image_w, image_h)
SELECT id, 1, 'banner', NULL, NULL,
  'https://cdn.vattimalaysia.com/2026/08/v936-hero.webp',
...
SELECT id, 2, 'split', 'A tower, after the Eiffel',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v936-tower.webp',
...
SELECT id, 3, 'split', 'R-arc edges and corners',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v936-arc-corner.webp',
...
SELECT id, 4, 'split', 'Two cavities, two pressure zones',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v936-double-cavity.webp',
...
SELECT id, 5, 'split', '98mm deeper hood cavity',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v936-deeper-cavity.webp',
...
SELECT id, 6, 'split', '35mm deeper filter area',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v936-filter-area.webp',
...
SELECT id, 7, 'split', '450 Pa, before the smoke escapes',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v936-negative-pressure.webp',
...
SELECT id, 8, 'split', 'Patented V-shaped motor housing',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v936-v-housing.webp',
...
SELECT id, 9, 'split', 'Steam, 125 times over',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v936-steam-clean.webp',
...
SELECT id, 10, 'split', 'Eighteen seconds of scouring, then spin dry',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v936-spin-dry.webp',
  'The V936 impeller spinning dry after a wash', 232, 522
  FROM product WHERE slug = 'athena-series-lifting-type-range-hood-v936';

INSERT INTO product_feature (product_id, position, layout, title, body_md, image_url, image_alt, image_w, image_h)
SELECT id, 11, 'banner', NULL, NULL,
  'https://cdn.vattimalaysia.com/2023/11/V936-Product-Detail-12.webp',
...
SELECT id, 1, 'split', '2,250 m³/h of turbo suction',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v917g-turbo.webp',
...
SELECT id, 2, 'split', '900 Pa of static pressure',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v917g-pressure.webp',
...
SELECT id, 3, 'split', 'Wave, do not print',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v917g-gesture.webp',
...
SELECT id, 4, 'split', 'Heat auto-clean',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v917g-heat-clean.webp',
...
SELECT id, 5, 'split', 'Seventeen minutes, seven stages',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v917g-clean-cycle.webp',
...
SELECT id, 6, 'split', 'The guide plate comes off',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v917g-guide-plate.webp',
...
SELECT id, 1, 'split', '2,250 m³/h of turbo suction',
  'Hurricane suction, in VATTI''s own words: enough to stop smoke standing in the kitchen while several stir-fry dishes go at once.',
  'https://cdn.vattimalaysia.com/2026/08/v917-turbo.webp',
...
SELECT id, 2, 'split', 'Wave, do not print',
  'Gesture control from a distance, so greasy fingertips never touch the panel: left to right turns it on and steps the air volume, right to left switches it off.',
  'https://cdn.vattimalaysia.com/2026/08/v917-gesture.webp',
...
SELECT id, 3, 'split', 'A 3D body, made for Malaysian kitchens',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v917-3d-design.webp',
...
SELECT id, 4, 'split', 'The guide plate comes off',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v917-guide-plate.webp',
...
SELECT id, 5, 'split', 'Heat auto-clean',
  'No water cup to fill: the cavity is heated in two high-frequency steps until the oil dissolves, and the fan throws it clear.',
  'https://cdn.vattimalaysia.com/2026/08/v917-heat-clean.webp',
...
SELECT id, 6, 'split', 'Seventeen minutes, seven stages',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v917-clean-cycle.webp',
...
SELECT id, 7, 'card', 'Calm and composed',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v917-batik-blue.webp',
...
SELECT id, 8, 'card', 'Classic and warm',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v917-batik-timber.webp',
...
SELECT id, 9, 'card', 'Clean and fresh',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v917-batik-white.webp',
...
SELECT id, 10, 'card', 'Warm and modern',
  ...
  'https://cdn.vattimalaysia.com/2026/08/v917-batik-warm.webp',
...
INSERT INTO product_feature (product_id, position, layout, title, body_md, image_url, image_alt, image_w, image_h)
SELECT id, 1, 'banner', NULL, NULL,
  'https://cdn.vattimalaysia.com/2026/08/dwbb7-hero.webp',
...
SELECT id, 2, 'split', '17 place settings',
  ...
  'https://cdn.vattimalaysia.com/2026/08/dwbb7-capacity.webp',
...
SELECT id, 3, 'split', 'Three spray levels, counter-rotating',
  ...
  'https://cdn.vattimalaysia.com/2026/08/dwbb7-spray-arms.webp',
...
SELECT id, 4, 'split', 'BLDC inverter motor',
  ...
  'https://cdn.vattimalaysia.com/2026/08/dwbb7-motor.webp',
...
SELECT id, 5, 'split', 'Triple disinfection',
  ...
  'https://cdn.vattimalaysia.com/2026/08/dwbb7-disinfection.webp',
...
SELECT id, 6, 'split', 'It keeps working after the cycle',
  ...
  'https://cdn.vattimalaysia.com/2026/08/dwbb7-ventilation.webp',
...
SELECT id, 7, 'split', 'Hybrid condensation drying',
  ...
  'https://cdn.vattimalaysia.com/2026/08/dwbb7-condensation.webp',
...
SELECT id, 8, 'split', '110°C independent drying',
  ...
  'https://cdn.vattimalaysia.com/2026/08/dwbb7-drying.webp',
...
SELECT id, 9, 'split', 'Two pumps, no standing water',
  ...
  'https://cdn.vattimalaysia.com/2026/08/dwbb7-pumps.webp',
...
SELECT id, 10, 'split', 'Zero residual detergent',
  ...
  'https://cdn.vattimalaysia.com/2026/08/dwbb7-zero-residual.webp',
...
SELECT id, 11, 'split', 'It looks at the load first',
  ...
  'https://cdn.vattimalaysia.com/2026/08/dwbb7-load-modes.webp',
...
SELECT id, 12, 'split', 'Seven core programmes, and twelve more',
  ...
  'https://cdn.vattimalaysia.com/2026/08/dwbb7-programme-tiles.webp',
...
SELECT id, 13, 'split', 'Three stages of filtration',
  ...
  'https://cdn.vattimalaysia.com/2026/08/dwbb7-filtration.webp',
...
SELECT id, 14, 'split', 'Level 1 water efficiency',
  ...
  'https://cdn.vattimalaysia.com/2026/08/dwbb7-energy.webp',
...
SELECT id, 15, 'card', 'Black crystal glass',
  ...
  'https://cdn.vattimalaysia.com/2026/08/dwbb7-glass.webp',
...
SELECT id, 16, 'card', 'All-steel liner',
  ...
  'https://cdn.vattimalaysia.com/2026/08/dwbb7-steel-liner.webp',
...
SELECT id, 17, 'card', 'Self-cleaning',
  ...
  'https://cdn.vattimalaysia.com/2026/08/dwbb7-self-clean.webp',
...
SELECT id, 18, 'card', '108mm PTC heater',
  ...
  'https://cdn.vattimalaysia.com/2026/08/dwbb7-heater.webp',
  'The extended PTC infrared ceramic heater', 268, 194
  FROM product WHERE slug = 'vatti-dishwasher-dwbb7';

INSERT INTO product_feature (product_id, position, layout, title, body_md, image_url, image_alt, image_w, image_h)
SELECT id, 19, 'banner', NULL, NULL,
  'https://cdn.vattimalaysia.com/2026/08/dwbb7-programmes.webp',
...
INSERT INTO product_feature (product_id, position, layout, title, body_md, image_url, image_alt, image_w, image_h)
SELECT id, 1, 'banner', NULL, NULL,
  'https://cdn.vattimalaysia.com/2026/08/wdhg01-hero.webp',
...
SELECT id, 2, 'split', 'Two boxes, one tap',
  ...
  'https://cdn.vattimalaysia.com/2026/08/wdhg01-under-cabinet.webp',
...
SELECT id, 3, 'split', 'Hot water in three seconds',
  ...
  'https://cdn.vattimalaysia.com/2026/08/wdhg01-fast-heat.webp',
...
SELECT id, 4, 'split', '600G, and a glass in six seconds',
  ...
  'https://cdn.vattimalaysia.com/2026/08/wdhg01-flow.webp',
...
- Post activated carbon, for the taste of what comes out',
  'https://cdn.vattimalaysia.com/2026/08/wdhg01-filters.webp',
...
SELECT id, 6, 'split', '0.0001 micron',
  ...
  'https://cdn.vattimalaysia.com/2026/08/wdhg01-ro.webp',
...
SELECT id, 7, 'split', 'Four temperatures, one touch',
  ...
  'https://cdn.vattimalaysia.com/2026/08/wdhg01-modes.webp',
...
SELECT id, 8, 'split', 'The tap tells you which',
  ...
  'https://cdn.vattimalaysia.com/2026/08/wdhg01-display.webp',
...
SELECT id, 9, 'split', 'One water channel, fewer joints',
  ...
  'https://cdn.vattimalaysia.com/2026/08/wdhg01-water-channel.webp',
...
SELECT id, 10, 'split', 'You change the filters yourself',
  ...
  'https://cdn.vattimalaysia.com/2026/08/wdhg01-filter-change.webp',
  'The WDHG01 with its top cover off and a filter exposed', 595, 429
  FROM product WHERE slug = 'vatti-one-tap-water-purifier-wdhg01-with-v818wd';

INSERT INTO product_feature (product_id, position, layout, title, body_md, image_url, image_alt, image_w, image_h)
SELECT id, 11, 'banner', NULL, NULL,
  'https://cdn.vattimalaysia.com/2026/08/wdhg01-change-steps.webp',
...
Which is roughly RM24 a month for the water a household drinks.',
  'https://cdn.vattimalaysia.com/2026/08/wdhg01-consumables.webp',
...
SELECT id, 13, 'split', 'Certified, and testable',
  ...
  'https://cdn.vattimalaysia.com/2026/08/wdhg01-certificates.webp',
  'The WDHG01 certification documents', 595, 581
  FROM product WHERE slug = 'vatti-one-tap-water-purifier-wdhg01-with-v818wd';

INSERT INTO product_feature (product_id, position, layout, title, body_md, image_url, image_alt, image_w, image_h)
SELECT id, 14, 'banner', NULL, NULL,
  'https://cdn.vattimalaysia.com/2026/08/wdhg01-temperatures.webp',
...
INSERT INTO product_feature (product_id, position, layout, title, body_md, image_url, image_alt, image_w, image_h)
SELECT id, 1, 'banner', NULL, NULL,
  'https://cdn.vattimalaysia.com/2026/08/va06-hero.webp',
...
SELECT id, 2, 'split', 'Five ovens in one cavity',
  ...
  'https://cdn.vattimalaysia.com/2026/08/va06-five-in-one.webp',
...
SELECT id, 3, 'split', 'A colour touch screen, partitioned by function',
  ...
  'https://cdn.vattimalaysia.com/2026/08/va06-screen.webp',
...
SELECT id, 4, 'split', 'Steam System 4.0',
  ...
  'https://cdn.vattimalaysia.com/2026/08/va06-steam.webp',
...
SELECT id, 5, 'split', 'Three humidity levels',
  ...
  'https://cdn.vattimalaysia.com/2026/08/va06-humidity.webp',
...
SELECT id, 6, 'split', 'Steam grill, against a dry oven',
  ...
  'https://cdn.vattimalaysia.com/2026/08/va06-steam-grill.webp',
...
SELECT id, 7, 'split', 'Humidity is the control, not the timer',
  ...
  'https://cdn.vattimalaysia.com/2026/08/va06-humidity-roast.webp',
...
SELECT id, 8, 'split', 'Which setting for which dish',
  ...
  'https://cdn.vattimalaysia.com/2026/08/va06-ingredients.webp',
...
SELECT id, 9, 'split', 'Steam bake, for bread',
  ...
  'https://cdn.vattimalaysia.com/2026/08/va06-bake-compare.webp',
...
SELECT id, 10, 'split', 'Air-fry, in two modes',
  ...
  'https://cdn.vattimalaysia.com/2026/08/va06-air-fry.webp',
...
SELECT id, 11, 'split', 'Root crops, or meat',
  ...
  'https://cdn.vattimalaysia.com/2026/08/va06-air-fry-modes.webp',
...
SELECT id, 12, 'split', 'Stew, on a curve',
  ...
  'https://cdn.vattimalaysia.com/2026/08/va06-stew.webp',
...
SELECT id, 13, 'split', 'Three stews',
  ...
  'https://cdn.vattimalaysia.com/2026/08/va06-stew-modes.webp',
...
SELECT id, 14, 'split', '68 recipes, already in it',
  ...
  'https://cdn.vattimalaysia.com/2026/08/va06-recipes.webp',
...
SELECT id, 15, 'split', 'Auto-clean',
  ...
  'https://cdn.vattimalaysia.com/2026/08/va06-auto-clean.webp',
...
INSERT INTO product_feature (product_id, position, layout, title, body_md, image_url, image_alt, image_w, image_h)
SELECT id, 1, 'banner', NULL, NULL,
  'https://cdn.vattimalaysia.com/2026/08/c836g-hero.webp',
...
SELECT id, 2, 'split', '5.5 kW, and the smell of it',
  ...
  'https://cdn.vattimalaysia.com/2026/08/c836g-power.webp',
...
- Outer ring, which widens the combustion area by 11% for large cookware',
  'https://cdn.vattimalaysia.com/2026/08/c836g-triple-ring.webp',
...
SELECT id, 4, 'split', 'Five flame levels, with a click',
  ...
  'https://cdn.vattimalaysia.com/2026/08/c836g-flame-control.webp',
...
- Dry-burn protection, which reacts to a rapid heat change',
  'https://cdn.vattimalaysia.com/2026/08/c836g-temperature.webp',
...
SELECT id, 6, 'split', 'A timer for each side',
  ...
  'https://cdn.vattimalaysia.com/2026/08/c836g-timer.webp',
...
SELECT id, 7, 'split', 'It starts the hood for you',
  ...
  'https://cdn.vattimalaysia.com/2026/08/c836g-hood-link.webp',
...
SELECT id, 8, 'split', 'It fits the hole you already have',
  ...
  'https://cdn.vattimalaysia.com/2026/08/c836g-cutout.webp',
...
SELECT id, 9, 'split', 'Nano coating, against the oil',
  ...
  'https://cdn.vattimalaysia.com/2026/08/c836g-nano-glass.webp',
...
SELECT id, 10, 'split', 'Made to come apart',
  ...
  'https://cdn.vattimalaysia.com/2026/08/c836g-easy-clean.webp',
...
SELECT id, 11, 'split', 'The wok support holds the flame in',
  ...
  'https://cdn.vattimalaysia.com/2026/08/c836g-wok-support.webp',
  'The C836G wok support with its features labelled', 1024, 737
  FROM product WHERE slug = 'vatti-flexi-hob-c836g';

INSERT INTO product_feature (product_id, position, layout, title, body_md, image_url, image_alt, image_w, image_h)
SELECT id, 12, 'banner', NULL, NULL,
  'https://cdn.vattimalaysia.com/2026/08/c836g-flame-art.webp',
...
INSERT INTO product_feature (product_id, position, layout, title, body_md, image_url, image_alt, image_w, image_h)
SELECT id, 1, 'banner', NULL, NULL,
  'https://cdn.vattimalaysia.com/2026/08/c822g-hero.webp',
...
SELECT id, 2, 'split', '5.2 kW, and the flame wraps the pan',
  ...
  'https://cdn.vattimalaysia.com/2026/08/c822g-firepower.webp',
...
SELECT id, 3, 'split', 'The difference it makes',
  ...
  'https://cdn.vattimalaysia.com/2026/08/c822g-wok-compare.webp',
...
SELECT id, 4, 'split', 'Torch-level co-combustion',
  ...
  'https://cdn.vattimalaysia.com/2026/08/c822g-burner.webp',
...
SELECT id, 5, 'split', '63% thermal efficiency',
  ...
  'https://cdn.vattimalaysia.com/2026/08/c822g-efficiency.webp',
...
SELECT id, 6, 'split', 'Set the time and walk away',
  ...
  'https://cdn.vattimalaysia.com/2026/08/c822g-timer.webp',
...
SELECT id, 7, 'split', 'It comes apart to clean',
  ...
  'https://cdn.vattimalaysia.com/2026/08/c822g-detachable.webp',
...
SELECT id, 8, 'split', 'Tempered glass, anti-scratch',
  ...
  'https://cdn.vattimalaysia.com/2026/08/c822g-glass.webp',
...
SELECT id, 9, 'split', 'X-shaped pan support',
  ...
  'https://cdn.vattimalaysia.com/2026/08/c822g-pan-support.webp',
...
SELECT id, 10, 'split', 'The details that decide it',
  ...
  'https://cdn.vattimalaysia.com/2026/08/c822g-details.webp',
...
INSERT INTO product_feature (product_id, position, layout, title, body_md, image_url, image_alt, image_w, image_h)
SELECT id, 1, 'banner', NULL, NULL,
  'https://cdn.vattimalaysia.com/2026/08/va05-hero.webp',
...
SELECT id, 2, 'split', 'Steam and bake, in one cavity',
  ...
  'https://cdn.vattimalaysia.com/2026/08/va05-in-kitchen.webp',
...
SELECT id, 3, 'split', 'Double steam, 360 degrees',
  ...
  'https://cdn.vattimalaysia.com/2026/08/va05-steam.webp',
...
SELECT id, 4, 'split', 'Heat from every side',
  ...
  'https://cdn.vattimalaysia.com/2026/08/va05-heating.webp',
...
SELECT id, 5, 'split', 'Top and bottom, controlled apart',
  ...
  'https://cdn.vattimalaysia.com/2026/08/va05-dual-control.webp',
...
SELECT id, 6, 'split', 'A probe, for doneness',
  ...
  'https://cdn.vattimalaysia.com/2026/08/va05-probe.webp',
...
SELECT id, 7, 'split', 'An enamel cavity',
  ...
  'https://cdn.vattimalaysia.com/2026/08/va05-enamel.webp',
...
SELECT id, 8, 'split', 'It descales and dries itself',
  ...
  'https://cdn.vattimalaysia.com/2026/08/va05-descale.webp',
...
SELECT id, 1, 'split', 'Three dishes at once',
  ...
  'https://cdn.vattimalaysia.com/2026/08/c830g-three-pans.webp',
...
SELECT id, 2, 'split', '6 kW across the three',
  ...
  'https://cdn.vattimalaysia.com/2026/08/c830g-power.webp',
...
SELECT id, 3, 'split', 'A 99 minute timer',
  ...
  'https://cdn.vattimalaysia.com/2026/08/c830g-timer.webp',
...
SELECT id, 4, 'split', 'A 1,059 g pan support',
  ...
  'https://cdn.vattimalaysia.com/2026/08/c830g-pan-support.webp',
...
SELECT id, 5, 'split', 'Six things that make it safe',
  ...
  'https://cdn.vattimalaysia.com/2026/08/c830g-safety.webp',
...
INSERT INTO product_feature (product_id, position, layout, title, body_md, image_url, image_alt, image_w, image_h)
SELECT id, 1, 'banner', NULL, NULL,
  'https://cdn.vattimalaysia.com/2025/07/VATTI-C823G-cooker-hob-4.webp',
...
SELECT id, 2, 'split', '4.8 kW, at 38 degrees',
  ...
  'https://cdn.vattimalaysia.com/2026/08/c823g-power.webp',
...
SELECT id, 3, 'split', 'It fits the hole you have',
  ...
  'https://cdn.vattimalaysia.com/2026/08/c823g-cutout.webp',
...
SELECT id, 4, 'split', 'Gas off, automatically',
  ...
  'https://cdn.vattimalaysia.com/2026/08/c823g-safety.webp',
...
SELECT id, 5, 'split', 'Lights immediately',
  ...
  'https://cdn.vattimalaysia.com/2026/08/c823g-ignition.webp',
...
INSERT INTO product_feature (product_id, position, layout, title, body_md, image_url, image_alt, image_w, image_h)
SELECT id, 1, 'banner', NULL, NULL,
  'https://cdn.vattimalaysia.com/2024/03/Magic-Stove-02.webp',
...
SELECT id, 2, 'split', 'The burner flips up',
  ...
  'https://cdn.vattimalaysia.com/2026/08/c861g-reversible.webp',
...
SELECT id, 3, 'split', 'Which means it wipes flat',
  ...
  'https://cdn.vattimalaysia.com/2026/08/c861g-easy-clean.webp',
...
SELECT id, 4, 'split', 'And it gives back the drawer',
  ...
  'https://cdn.vattimalaysia.com/2026/08/c861g-save-space.webp',
...
SELECT id, 5, 'split', 'Oxygen from three sides',
  ...
  'https://cdn.vattimalaysia.com/2026/08/c861g-oxygen.webp',
...
SELECT id, 6, 'split', '4.8 kW, in seven gears',
  ...
  'https://cdn.vattimalaysia.com/2026/08/c861g-power.webp',
...
SELECT id, 7, 'split', 'It reads the pot',
  ...
  'https://cdn.vattimalaysia.com/2026/08/c861g-sensor.webp',
...
SELECT id, 8, 'split', 'Left and right, managed separately',
  ...
  'https://cdn.vattimalaysia.com/2026/08/c861g-management.webp',
...
SELECT id, 9, 'split', 'Three protections on the left burner',
  ...
  'https://cdn.vattimalaysia.com/2026/08/c861g-temperature.webp',
...
SELECT id, 10, 'split', 'A full touch interface',
  ...
  'https://cdn.vattimalaysia.com/2026/08/c861g-touch.webp',
...
INSERT INTO product_feature (product_id, position, layout, title, body_md, image_url, image_alt, image_w, image_h)
SELECT id, 1, 'banner', NULL, NULL,
  'https://cdn.vattimalaysia.com/2026/08/c835g-hero.webp',
...
SELECT id, 2, 'split', 'Spinning and even fire',
  ...
  'https://cdn.vattimalaysia.com/2026/08/c835g-flame.webp',
...
SELECT id, 3, 'split', 'Eight speeds, 400 W to 4,500 W',
  ...
  'https://cdn.vattimalaysia.com/2026/08/c835g-eight-speed.webp',
...
SELECT id, 4, 'split', 'It holds a soup at 100°C',
  ...
  'https://cdn.vattimalaysia.com/2026/08/c835g-intelligent.webp',
...
SELECT id, 5, 'split', 'It matches the pot',
  ...
  'https://cdn.vattimalaysia.com/2026/08/c835g-pot-mode.webp',
...
SELECT id, 6, 'split', 'Anti-dry burning, and a 99 minute timer',
  ...
  'https://cdn.vattimalaysia.com/2026/08/c835g-timer.webp',
...
SELECT id, 7, 'split', '3D oxygen input',
  ...
  'https://cdn.vattimalaysia.com/2026/08/c835g-oxygen.webp',
...
SELECT id, 8, 'card', 'Jet rotor fire cover',
  ...
  'https://cdn.vattimalaysia.com/2026/08/c835g-gold-trim.webp',
...
SELECT id, 9, 'card', 'Enamel cross pot holder',
  ...
  'https://cdn.vattimalaysia.com/2026/08/c835g-panel.webp',
...
INSERT INTO product_feature (product_id, position, layout, title, body_md, image_url, image_alt, image_w, image_h)
SELECT id, 1, 'banner', NULL, NULL,
  'https://cdn.vattimalaysia.com/2026/08/c720s-hero.webp',
...
SELECT id, 2, 'split', 'The "Thor" burner',
  ...
  'https://cdn.vattimalaysia.com/2026/08/c720s-thor.webp',
...
SELECT id, 3, 'split', 'X-Max square pan support',
  ...
  'https://cdn.vattimalaysia.com/2026/08/c720s-pan-support.webp',
...
SELECT id, 4, 'split', 'One integrated top sheet',
  ...
  'https://cdn.vattimalaysia.com/2026/08/c720s-easy-clean.webp',
...
SELECT id, 5, 'split', 'A child lock in the valve',
  ...
  'https://cdn.vattimalaysia.com/2026/08/c720s-child-lock.webp',
...
SELECT id, 6, 'split', 'A Spanish flame failure device',
  ...
  'https://cdn.vattimalaysia.com/2026/08/c720s-flame-failure.webp',
  'The C720S burner ring and its flame failure sensor', 640, 332
  FROM product WHERE slug = 'professional-series-c720s';

INSERT INTO product_feature (product_id, position, layout, title, body_md, image_url, image_alt, image_w, image_h)
SELECT id, 7, 'banner', NULL, NULL,
  'https://cdn.vattimalaysia.com/2026/08/c720s-detail.webp',
...
SELECT id, 1, 'split', 'Rotational polythermal force',
  ...
  'https://cdn.vattimalaysia.com/2026/08/c821g-hero.webp',
...
SELECT id, 2, 'split', '3D oxygen input',
  ...
  'https://cdn.vattimalaysia.com/2026/08/c821g-oxygen.webp',
...
SELECT id, 3, 'split', 'On the counter, or into it',
  ...
  'https://cdn.vattimalaysia.com/2026/08/c821g-install.webp',
...
SELECT id, 4, 'split', 'The valve closes itself',
  ...
  'https://cdn.vattimalaysia.com/2026/08/c821g-safety.webp',
...
SELECT id, 1, 'split', 'Micro-flame combustion',
  ...
  'https://cdn.vattimalaysia.com/2026/08/m822g-microflame.webp',
...
SELECT id, 2, 'split', 'The Olympic plate',
  ...
  'https://cdn.vattimalaysia.com/2026/08/m822g-plate.webp',
...
SELECT id, 3, 'split', 'It was a torch first',
  ...
  'https://cdn.vattimalaysia.com/2026/08/m822g-torch.webp',
...
SELECT id, 4, 'split', 'Steam on the left, stir-fry on the right',
  ...
  'https://cdn.vattimalaysia.com/2026/08/m822g-partition.webp',
...
SELECT id, 5, 'split', '3D oxygen input',
  ...
  'https://cdn.vattimalaysia.com/2026/08/m822g-oxygen.webp',
...
SELECT id, 6, 'split', 'Safety, and the glass',
  ...
  'https://cdn.vattimalaysia.com/2026/08/m822g-safety.webp',
  'The M822G safety valve and glass top', 1280, 360
  FROM product WHERE slug = 'vatti-oylimpic-hob-m822g';

INSERT INTO product_feature (product_id, position, layout, title, body_md, image_url, image_alt, image_w, image_h)
SELECT id, 7, 'banner', NULL, NULL,
  'https://cdn.vattimalaysia.com/2026/08/m822g-kitchen.webp',
...
INSERT INTO product_feature (product_id, position, layout, title, body_md, image_url, image_alt, image_w, image_h)
SELECT id, 1, 'banner', NULL, NULL,
  'https://cdn.vattimalaysia.com/2026/08/o755p-hero.webp',
...
SELECT id, 2, 'split', '75 litres, on five levels',
  ...
  'https://cdn.vattimalaysia.com/2026/08/o755p-capacity.webp',
...
SELECT id, 3, 'split', 'Eleven baking modes',
  ...
  'https://cdn.vattimalaysia.com/2026/08/o755p-modes.webp',
...
SELECT id, 4, 'split', 'A ceramic cavity, not enamel',
  ...
  'https://cdn.vattimalaysia.com/2026/08/o755p-ceramic.webp',
...
SELECT id, 5, 'split', 'The difference against enamel',
  ...
  'https://cdn.vattimalaysia.com/2026/08/o755p-enamel.webp',
...
SELECT id, 6, 'split', 'Telescopic runners',
  ...
  'https://cdn.vattimalaysia.com/2026/08/o755p-runners.webp',
...
SELECT id, 7, 'split', 'Soft open, soft close',
  ...
  'https://cdn.vattimalaysia.com/2026/08/o755p-soft-close.webp',
...
SELECT id, 8, 'split', 'Child lock, and an alarm',
  ...
  'https://cdn.vattimalaysia.com/2026/08/o755p-child-lock.webp',
  'The O755P control panel with the child lock engaged', 691, 973
  FROM product WHERE slug = 'vatti-built-in-oven-o755p';

INSERT INTO product_feature (product_id, position, layout, title, body_md, image_url, image_alt, image_w, image_h)
SELECT id, 9, 'banner', NULL, NULL,
  'https://cdn.vattimalaysia.com/2026/08/o755p-layers.webp',
...
INSERT INTO product_feature (product_id, position, layout, title, body_md, image_url, image_alt, image_w, image_h)
SELECT id, 1, 'banner', NULL, NULL,
  'https://cdn.vattimalaysia.com/2026/08/o7559-hero.webp',
...
SELECT id, 2, 'split', 'Air-fry, in a full-size oven',
  ...
  'https://cdn.vattimalaysia.com/2026/08/o7559-airfry.webp',
...
SELECT id, 3, 'split', '75 litres',
  ...
  'https://cdn.vattimalaysia.com/2026/08/o7559-capacity.webp',
...
SELECT id, 4, 'split', 'Nine baking modes',
  ...
  'https://cdn.vattimalaysia.com/2026/08/o7559-modes.webp',
...
SELECT id, 5, 'split', 'The door comes off without tools',
  ...
  'https://cdn.vattimalaysia.com/2026/08/o7559-door.webp',
...
INSERT INTO product_feature (product_id, position, layout, title, body_md, image_url, image_alt, image_w, image_h)
SELECT id, 1, 'banner', NULL, NULL,
  'https://cdn.vattimalaysia.com/2026/08/o7549-hero.webp',
...
SELECT id, 2, 'split', '75 litres of convection',
  ...
  'https://cdn.vattimalaysia.com/2026/08/o7549-capacity.webp',
...
SELECT id, 3, 'split', 'Nine baking modes',
  ...
  'https://cdn.vattimalaysia.com/2026/08/o7549-modes.webp',
...
SELECT id, 4, 'split', 'The door comes off without tools',
  ...
  'https://cdn.vattimalaysia.com/2026/08/o7549-door.webp',
  'The O7549 door being lifted off, its glass layers labelled', 691, 1024
  FROM product WHERE slug = 'vatti-built-in-oven-o7549';

INSERT INTO product_feature (product_id, position, layout, title, body_md, image_url, image_alt, image_w, image_h)
SELECT id, 5, 'banner', NULL, NULL,
  'https://cdn.vattimalaysia.com/2023/11/Built-in-Oven-O754-3.webp',
...
INSERT INTO product_feature (product_id, position, layout, title, body_md, image_url, image_alt, image_w, image_h)
SELECT id, 1, 'banner', NULL, NULL,
  'https://cdn.vattimalaysia.com/2023/11/Built-in-Combi-Oven-VA03-2-1.webp',
...
SELECT id, 2, 'split', 'Fourteen cooking functions',
  ...
  'https://cdn.vattimalaysia.com/2026/08/va03-hero.webp',
...
SELECT id, 3, 'split', 'Two nozzles, no dripping',
  ...
  'https://cdn.vattimalaysia.com/2026/08/va03-nozzle.webp',
...
SELECT id, 4, 'split', 'A 1.3 litre tank you can reach',
  ...
  'https://cdn.vattimalaysia.com/2026/08/va03-tank.webp',
...
SELECT id, 5, 'split', '3D convection',
  ...
  'https://cdn.vattimalaysia.com/2026/08/va03-convection.webp',
...
SELECT id, 6, 'split', 'Top and bottom, set apart',
  ...
  'https://cdn.vattimalaysia.com/2026/08/va03-dual-temp.webp',
...
SELECT id, 7, 'split', 'Three humidity levels, three results',
  ...
  'https://cdn.vattimalaysia.com/2026/08/va03-humidity.webp',
...
SELECT id, 8, 'split', '68 auto menus',
  ...
  'https://cdn.vattimalaysia.com/2026/08/va03-menus.webp',
...
SELECT id, 9, 'split', 'Blue enamel, and a cycle that cleans it',
  ...
  'https://cdn.vattimalaysia.com/2026/08/va03-enamel.webp',
...
SELECT id, 1, 'split', '42 litres, and a dual nozzle',
  ...
  'https://cdn.vattimalaysia.com/2026/08/z4501-hero.webp',
...
SELECT id, 2, 'split', 'Steam and grill, 100°C to 230°C',
  ...
  'https://cdn.vattimalaysia.com/2026/08/z4501-steam-grill.webp',
...
SELECT id, 3, 'split', 'Top and bottom heating tape',
  ...
  'https://cdn.vattimalaysia.com/2026/08/z4501-no-drip.webp',
...
SELECT id, 4, 'split', '68 chef recipes, adjusted to the portion',
  ...
  'https://cdn.vattimalaysia.com/2026/08/z4501-recipes.webp',
...
INSERT INTO product_feature (product_id, position, layout, title, body_md, image_url, image_alt, image_w, image_h)
SELECT id, 1, 'banner', NULL, NULL,
  'https://cdn.vattimalaysia.com/2026/08/va01-hero.webp',
...
SELECT id, 2, 'split', 'Steam and grill together',
  ...
  'https://cdn.vattimalaysia.com/2026/08/va01-steam-grill.webp',
