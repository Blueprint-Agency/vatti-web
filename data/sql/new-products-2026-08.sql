-- V959 (hood) and VH-IC9-LA (hob): folders from the 2026-08 shoot with no
...
INSERT INTO image (id, url, legacy_url, alt, width, height) VALUES (9074, 'https://cdn.vattimalaysia.com/2026/08/vatti-cooker-hood-v959-front.webp', NULL, 'Vatti Cooker Hood V959, front view', 1051, 1066);
INSERT INTO image (id, url, legacy_url, alt, width, height) VALUES (9075, 'https://cdn.vattimalaysia.com/2026/08/vatti-cooker-hood-v959-front-open.webp', NULL, 'Vatti Cooker Hood V959, front view, canopy open', 1080, 1059);
INSERT INTO image (id, url, legacy_url, alt, width, height) VALUES (9076, 'https://cdn.vattimalaysia.com/2026/08/vatti-cooker-hood-v959-quarter-front-open.webp', NULL, 'Vatti Cooker Hood V959, angled view, open', 993, 1068);
INSERT INTO image (id, url, legacy_url, alt, width, height) VALUES (9077, 'https://cdn.vattimalaysia.com/2026/08/vatti-cooker-hood-v959-side.webp', NULL, 'Vatti Cooker Hood V959, side view', 382, 1058);
INSERT INTO image (id, url, legacy_url, alt, width, height) VALUES (9078, 'https://cdn.vattimalaysia.com/2026/08/vatti-cooker-hood-v959-side-open.webp', NULL, 'Vatti Cooker Hood V959, side view, open', 381, 1055);
INSERT INTO image (id, url, legacy_url, alt, width, height) VALUES (9079, 'https://cdn.vattimalaysia.com/2026/08/vatti-cooker-hob-vh-ic09al-front.webp', NULL, 'Vatti Cooker Hob VH-IC9-LA, front view', 1052, 588);
INSERT INTO image (id, url, legacy_url, alt, width, height) VALUES (9080, 'https://cdn.vattimalaysia.com/2026/08/vatti-cooker-hob-vh-ic09al-layer-16.webp', NULL, 'Vatti Cooker Hob VH-IC9-LA, detail view', 1051, 278);
...
INSERT INTO product_image (product_id, image_id, position, role) VALUES ((SELECT id FROM product WHERE slug = 'vatti-cooker-hob-vh-ic9-la'), 9079, 900, 'hero');
INSERT INTO product_image (product_id, image_id, position, role) VALUES ((SELECT id FROM product WHERE slug = 'vatti-cooker-hob-vh-ic9-la'), 9080, 901, 'gallery');
...
INSERT INTO product_collection_member (collection_id, product_id) VALUES ((SELECT id FROM product_collection WHERE slug = 'family-everyday-cooking' AND category_id = (SELECT id FROM product_category WHERE slug = 'cooker-hob-in-malaysia')), (SELECT id FROM product WHERE slug = 'vatti-cooker-hob-vh-ic9-la'));
